...
public class Prueba {
    ...
    public static void main(String[] args) {
        ...
        */
        Auto auto1=new Auto("Doble", 5,8, true, 4, "Manual", "Tranporte tipo Jeep", 240.20, 01, "Patrol","AVCH-9560", "Nissan");
        Auto auto2=new Auto("Trasera", 3,8, true, 4, "Automatica", "Automovil ", 320.20, 02, "Mustang GT","ARTG-5860", "Ford");
        Moto moto1=new Moto(true, 1.30, 1, true, 2, "Manual", "De pista", 320.30, 03, "S-1000 Rr", "AVH-698", "BMW");
        Moto moto2=new Moto(false, 1.70, 1, false, 2, "Manual", "De Cross", 320.30, 04, "CRF150-RB", "ATU-698", "Honda");
        Avion avion1=new Avion("Qatar Airways", 60, 10.5, 20, 4, 200, 300.4, 230, 05, "747", "JKI-985", "Boeing");
        Avion avion2=new Avion("Fly Emirates", 80, 12.5, 29, 4, 250, 350.4, 250, 05, "A320", "SLO-565", "Airbus");
        Helicoptero heli1=new Helicoptero(320.3, 6, 2, 10.2, 2, 4, 300.2, 50, 06, "AH-64 Apache", "DLIF-965", "Boeing");
        Helicoptero heli2=new Helicoptero(327.3, 8, 2, 20.2, 2, 6, 350.2, 70.3, 07, "Ka-52 'Alligator' ", "SLOK-256", "Kamov");
        /*
